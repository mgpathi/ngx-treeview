...
import {
    ...
    TreeviewEventParser, OrderDownlineTreeviewEventParser, DownlineTreeviewItem,DownlineTreeviewEventParser
} from 'ngx-treeview';
...
@Component({
    ...
    template: `
    <div class="row">
        <label class="form-check-label">Show selected only</label>
        <input type="checkbox" class="form-check-input" (change)="showSelected(isChecked)" [(ngModel)]="isChecked">
    </div>
...
export class ProductComponent implements OnInit {
    ...
    showSelected(isChecked){
        console.log("Inside of show selected");
    }
}
